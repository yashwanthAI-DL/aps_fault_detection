...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self)->artifact_entity.ModelEvaluateArtifact:
        try:
            ...
            if latest_dir_path==None:
                model_eval_artifact = artifact_entity.ModelEvaluateArtifact(is_model_accepted=True,
            ...
            #comparision between previous model and current model
